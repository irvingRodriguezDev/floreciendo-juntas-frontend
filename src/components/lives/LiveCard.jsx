...
import { useNavigate } from "react-router-dom"; // 👈 Usamos useNavigate para evitar el tag <a>
  ...
  return (
    <Card
      ...
      sx={{
        ...
        // Animación de entrada por CSS en lugar de framer-motion
        animation: `fadeInUpCard 0.5s cubic-bezier(0.16, 1, 0.3, 1) ${i * 0.06}s both`,
        "@keyframes fadeInUpCard": {
          "0%": { opacity: 0, transform: "translateY(24px)" },
          "100%": { opacity: 1, transform: "translateY(0)" },
        },

        // Efectos interactivos nativos
