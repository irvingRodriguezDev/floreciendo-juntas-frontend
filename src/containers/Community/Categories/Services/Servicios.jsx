...
const Servicios = ({
  ...
  return (
    <Grid container spacing={3} justifyContent='center' sx={{ pb: 6 }}>
      {/* 2. BUSCADOR (Sin márgenes negativos bruscos) */}
      <Grid size={12} sx={{ mt: -7 }}>
        <SearchCourse
          setSearch={setSearch}
          placeholder='Escribe para buscar publicaciones o servicios...'
        />
      </Grid>
        ...
        <Stack spacing={3}>
          {loading ? (
            ...
            >
              ...
              >
                {debounceSearch
                  ? `No encontramos nada con "${debounceSearch}". Intenta con otras palabras clave.`
